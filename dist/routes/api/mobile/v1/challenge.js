...
var Challenge_1 = require("../../../../mvc/models/mobile/Challenge");
var ApiResult_1 = require("./ApiResult");
var router = express.Router();
router.route("/current").get(function (_, res) {
    Challenge_1.Challenge.findOne({ id: db_constants_1.SPONSOR_CHALLENGE_CONSTANT }).exec(function (err, challenge) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!challenge) return [3, 2];
                    return [4, Challenge_1.challengeToResponse(err, challenge)];
                case 1:
                    (_a.sent()).sendJson(res);
                    return [3, 3];
                case 2:
                    console.log("Challenge: Challenge undefined");
                    ApiResult_1.ApiResult.sendJson(res, [err, "Challenge undefined"], null);
                    _a.label = 3;
                case 3: return [2];
            }
        });
